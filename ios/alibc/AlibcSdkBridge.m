...
- (void)init: (RCTResponseSenderBlock)callback
{
  ...
  taokeParams.pid = @"mm_15696989_43482139_342476422";
  taokeParams.adzoneId=@"342476422";
  NSDictionary *dic1=[NSDictionary dictionaryWithObject:@"24829070" forKey:@"taokeAppkey"];
  taokeParams.extParams=dic1;
